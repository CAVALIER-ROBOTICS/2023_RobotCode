...
public class WristRotateCounterCommand extends CommandBase {
  /** Creates a new WristRotateCounterCommand. */
  WristRotateSubsystem wristRotSub;
  public WristRotateCounterCommand(WristRotateSubsystem wSub) {
    wristRotSub = wSub;
